...
rejections and a 32-event round trip. The first [fixed-point arithmetic component
and error specification](FACTORED_NUMERICS.md) are now implemented in Solidity.
Graph traversal and validation remain the next gate before contract execution.
