...
fees, rounding and remaining escrow backing. [Atomic arbitrage tests](ARBITRAGE_REHEARSAL.md)
now pass locally in both directions; autonomous operation and live anchoring
remain outstanding. The CRE receiver still targets
