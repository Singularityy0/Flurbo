declare module '*.mjs' {
  ...
  export function mountDashboard(root: ShadowRoot, options?: { account?: string; consumer?: boolean; credentials?: string; marketId?: 'original' | 'learning'; onBusy?: (busy: boolean) => void; providers?: {name: string; provider: unknown}[]; onSnapshot?: (data: unknown) => void }): () => void;
}
