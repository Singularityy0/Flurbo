import { ArrowUpRight, CircleArrowLeft, LockKeyhole, Sparkles } from "lucide-react";
    ...
    <main id="main" tabIndex={-1} className="auth-page section-light">
      <div className="auth-grid">
        <div className="auth-aside">
          ...
          <div className="auth-aside-copy"><span className="eyebrow">{isLogin ? "Welcome back, eventually" : "Make a little room"}</span><h1>{isLogin ? "Sign in when the door is ready." : "Create your place in the picture."}</h1><p>{isLogin ? "We’re shaping the account experience around clarity and control. It isn’t available in this preview yet." : "Accounts are part of the future Flurbo experience — not something this design preview pretends to create."}</p></div>
        ...
        <div className="auth-panel-wrap">
          <div className="auth-panel">
            ...
            <p className="auth-panel-copy">{isLogin ? "Mera passkey authentication is planned for a future release. For now, this screen is here to show the direction — not to collect credentials." : "We’re not collecting email addresses, passwords, or passkeys here. This screen is a visual preview of the future account path."}</p>
            <div className="honesty-note"><Sparkles size={15} /><span>No credentials collected. No account created. No fake success.</span></div>
