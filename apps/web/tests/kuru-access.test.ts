...
test('hosted Kuru reads require login and Mera raw submission is disabled', async () => {
  ...
  const server = productionServer({previewAccess:null,  testingOperatorAccount:signer.address.toLowerCase(), origin, rpcUrl: TESTNET.rpc, learningDashboardUrl: 'http://127.0.0.1:18768' }, store);
